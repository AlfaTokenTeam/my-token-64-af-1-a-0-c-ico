...
import "./MyToken64AF1A0C.sol";

contract MyToken64AF1A0CPreSale {
    MyToken64AF1A0C public token;
    ...
    function MyToken64AF1A0CPreSale(
        MyToken64AF1A0C _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken64AF1A0C(_token);
